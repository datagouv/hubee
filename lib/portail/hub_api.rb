...
module Portail
  ...
  module HubAPI
    ...
    # La démarche n'autorise pas l'attente de compléments : ni une panne, ni une erreur de l'agent,
    # mais un refus à montrer tel quel.
    class AwaitingDocumentsNotAllowed < Error; end
    ...
    class << self
      ...
      def translated(error)
        ...
        when HubApiV1::V2::AwaitingDocumentsNotAllowedError
          AwaitingDocumentsNotAllowed.new(error.message)
