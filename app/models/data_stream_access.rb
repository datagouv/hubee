...
# Habilitation d'un agent, dans une organisation donnée, sur un flux de la V1 désigné
# par son code. Référence, jamais une copie : la V1 n'expose aucun libellé.
#
# Ne vérifie pas que l'organisation est abonnée au flux — l'abonnement vit en V1 et
# ce dépôt ne peut pas le contrôler. C'est un invariant qui engage les producteurs.
class DataStreamAccess < ApplicationRecord
  # === Associations ===
