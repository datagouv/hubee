...
module Portail
  ...
  # d'accès, pas de statut. Le nom du flux est posé ici à plat : l'amont ne le sert qu'avec
  # l'abonnement, et un télédossier ne porte que l'identité de son flux. Homonyme de
  # ::Subscription, le modèle ActiveRecord : dans `module Portail`, un `Subscription` nu résout
  # vers cette constante-ci.
