...
module Portail
  module Sessions
    class Create
      ...
      # pourquoi le plancher est là, sont décrits par Portail::Access::AuthenticationLevels.
      class CheckAuthenticationLevel
        include Interactor

        def call
          return if Portail::Access::AuthenticationLevels.accepted?(context.claims[:acr])
