    ...
    class Show
      class FindDelivery
        ...
        def call
          ...
          # `/teledossiers/%20` ne doit rien déclencher de plus.
        ...
        def not_found(reason)
          Rails.logger.info("Télédossier introuvable en amont", id: context.id, reason:)
        ...
        def unavailable(error)
          Rails.logger.error("Télédossiers indisponibles — #{error.class} : #{error.message}")
