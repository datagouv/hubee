...
# d'un flux — sans que rien ne le dise.
#
...
unless ENV.key?("SENSITIVE_DATA_STREAM_CODES") || ENV["SECRET_KEY_BASE_DUMMY"].present?
  raise "SENSITIVE_DATA_STREAM_CODES est requise — voir .env.example"
end
